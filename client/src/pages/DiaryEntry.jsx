...
function EntriesForm() {
    ...
    const [isActivityDescriptionFilled, setIsActivityDescriptionFilled] = useState(false);
    const [isIssueFilled, setIsIssueFilled] = useState(false);
    const [isIssueDescriptionFilled, setIsIssueDescriptionFilled] = useState(false);
    ...
    const isFormValid = () => {
        return (
            ...
            && isActivityFilled && isActivityDescriptionFilled && isDateValid()
            && isIssueFilled && isIssueDescriptionFilled
        );
    };
    ...
    return (
        <div>
            ...
            {!isFormValid() ? (
                <p style={{ color: 'red' }}>Please fill in all fields correctly before submitting</p>
            ) : null}
